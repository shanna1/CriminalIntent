...
import com.bigneardranch.android.criminalintent.database.PictureUtils;
...
public class CrimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final CheckBox mSolvedCheckBox = (CheckBox) v.findViewById(R.id.crime_solved);
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(getActivity(), "Deleting crime", Toast.LENGTH_SHORT).show();
